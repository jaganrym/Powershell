...
param ($identity)
    ...
    if($user.samaccountname -ne "shardy"){
        if($user.enabled){
            $user
            $user.directreports|%{
...
#Lab Science Ashland / Skokie
$usersublist=get-adindirectreport cr201939
$hashtable.add(@("Global Auto Business - Lab Sci - Ashland-Skokie","Global Employees - Lab Sci - Ashland-Skokie"),@($usersublist|select -expandproperty samaccountname))
#Lab Science Lyon
...
$usersublist2=get-adindirectreport cr202908
...
#Lab Science MPI
$usersublist=get-adindirectreport cr212574
$hashtable.add(@("Global Auto Business - Lab Sci - MPI","Global Employees - Lab Sci - MPI"),@($usersublist|select -expandproperty samaccountname))
