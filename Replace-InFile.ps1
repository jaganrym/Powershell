...
<#Usage example :- C:\Users\cr201659\"OneDrive - Yash Technologies Pvt Ltd\Powershell"\Replace-InFile.ps1 -Pattern "Jerome" -Replacement "Jerome1" -Path C:\members.txt -Overwrite
Processing file 'C:\members.txt'#> 
<#
.Synopsis
